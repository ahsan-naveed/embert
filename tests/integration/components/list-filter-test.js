...
module('Integration | Component | list-filter', function(hooks) {
  ...
  test('should initially load all listings', async function(assert) {
    ...
    // we can set up and use the component in the same
    // way our application will use it
    await render(hbs`
    ...
    // settled waits for all asynchronous tasks to complete
    // before running the given function callback
    return settled().then(() => {
